...
set1.pcap
1. There are 276 packets in set1.pcap
2. It looks like FTP was the protocal used to transfer files
3. The username and password aren't encrypted.
4. Use a secured FTP that encrypts the content, such as SSL/TLS ("FTPS").
5. 67.23.79.113 is the IP address of the server.
6. The username was: stokerj
   The password was: w00tfu!
7. 3
8. code.rtf secret.pdf acb.jpg
9. (Look at all the FTP-data protocol packets and open up each separate one)

set2.pcap
10.There are 74566 packets in set2.pcap.
11.There are 4 username password pairs.
12. To find the username-password pairs
    1. I went to the Edit menu
    2. Selected Find Packet
    3. Selected String as the filter type
    4. Typed in pass, password, LOGIN (to look for passwords)
    5. Found a user entering a password
   6. Filtered for the protocol used on the transaction
13.
        username-pw       protocol      IP             domain   port number
        e129286 4.Ekkama  POP           144.122.144.179    arikanda.general.services.metu.edu.tr    110
        dmartini@cutaway.it  sellasa   IMAP   109.168.119.166   mail.cutaway.it  143
        mbergeson@hjnews.com mb123on  POP 67.128.149.178   mail.newswest.com   110
        brewer lqazxsw209simona12   POP  62.173.185.22     imartini.it  110

14. three got in and one didn't.
15. Followed the conversation and saw if they had successful/unsuccesful log ins
16. It is inappropriate to log in using other people's accounts, and this is from defcon so it is scary.
17. use a secure protocal, encrypted

18.  Statistics->show address resolution
...
SNM = .04%
  ...
  TCP is the most popular protocal, at 96%. 

20. I can learn all about Biometrics and SmartCard tokens, centralized backups, from some of the files sent to the server! It's like I'm at Defcon.
